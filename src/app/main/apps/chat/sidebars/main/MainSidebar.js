...
import ContactListItemContact from "./ContactListItemContact";
        ...
        <div className="flex justify-between items-center mb-16">
          {user && (
            ...
            >
              ...
              <Avatar src={user?.data?.profilePicture} alt={user?.data?.displayName} />

              <Typography className="mx-16 font-medium">{user.data.displayName}</Typography>
            </div>
          )}
